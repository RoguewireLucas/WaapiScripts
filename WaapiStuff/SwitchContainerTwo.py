...
try:
    ...
    with WaapiClient() as client:
        ...
        for x in result.get("objects"):
            ...
            NewName = SelectedObjectName[:-2]

            if NewName not in ExistingSwitches:
                ...
                ExistingSwitches[NewName] = NewSwitchId

            else:
                
                NewSwitchId = ExistingSwitches[NewName]
            ...
            if(SelectedObjectName[len(SelectedObjectName) - 2:] == "_F"):
                assign_switch_state= {
            ...
            elif(SelectedObjectName[len(SelectedObjectName) - 2:] == "_M"):    
                assign_switch_state= {
                    "child": SelectedObjectId,
                    "stateOrSwitch" : "\Switches\Default Work Unit\Oracle_Gender\Male"
                }
